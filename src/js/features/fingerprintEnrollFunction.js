...
showPageCount(fingerprintTable,  'viewFingerprintPrevBtn', 'viewFingerprintNextBtn', 'viewFingerprintPageCount', fingerprintNoTesult);
...
let fingerprintModal= '';

function editfingerprint(data) {
	fingerprintModal = 'edit';
	...
	$('#fingerprintNameEdit').val(data.attendance_id);
	// console.log(data);
...
$(document).ready(function () {
	...
	$('#fingerprintForm').submit(function (e) {
		...
		if (valid === true && submitForms == true) {
			...
			if(fingerprintModal == 'edit'){
			 readytoPost(parseInt(data.fingerprintNameEdit), listSampleFormat, fingerprintModal, 'src/function/core/enroll.php', 'User  updated successfully', 'register');
