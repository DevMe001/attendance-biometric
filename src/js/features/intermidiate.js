...
function verifyIdentity(sample){
	...
	console.log(listSampleFormat,'get sample');
	...
	const selectedId = $('#attendanceName').val();

	
	let isValidToProceed = $('#attendanceListForm').valid();

	if(isValidToProceed){


		console.log(listSampleFormat,'get sample format');


		readytoPost(parseInt(selectedId), listSampleFormat, 'src/function/core/verify.php','User  verified successfully');
