...
<hr/>
  ...
  <div class='flex justify-end gap-2 pr-5 items-center'>
      ...
      <span>
        <button id='viewYearPrevBtn' onclick='prevBtn(".year-table","yrNoResult","viewYearPrevBtn", "viewYearNextBtn", "viewYearPageCount")'
          class='prev btn btn-blue-500 p-2 text-gray-500 rounded'>Prev</button>
      </span>
      <span> |</span>
      <span class="text-gray-500" id='viewYearPageCount'> 1</span>
      <span> |</span>
      <span>
        <button id='viewYearNextBtn' onclick='nextBtn(".year-table","yrNoResult","viewYearPrevBtn", "viewYearNextBtn", "viewYearPageCount")'
