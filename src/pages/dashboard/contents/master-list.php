...
<form method="post" action="" >
  ...
  <?php
    ...
    <div class='flex justify-end gap-2 pr-5 items-center'>
      ...
      <span>
        <button id='viewmasterlistPrevBtn' onclick='prevBtn(".student-table","studentRecNoResult","viewmasterlistPrevBtn", "viewmasterlistNextBtn", "viewmasterlistPageCount")'
          class='prev btn btn-blue-500 p-2 text-gray-500 rounded'>Prev</button>
      </span>
      <span> |</span>
      <span class="text-gray-500" id='viewmasterlistPageCount'>1</span>
      <span> |</span>
      <span>
        <button id='viewmasterlistNextBtn' onclick='nextBtn(".student-table","studentRecNoResult","viewmasterlistPrevBtn", "viewmasterlistNextBtn", "viewmasterlistPageCount")'
