...
<!-- end attendace -->
  ...
  <div class='flex justify-end gap-2 pr-5 items-center'>
      ...
      <span>
        <button id='viewFingerprintPrevBtn' onclick='prevBtn(".fingerprint-table","fingerprintNoResult","viewFingerprintPrevBtn", "viewFingerprintNextBtn", "viewFingerprintPageCount")'
          class='prev btn btn-blue-500 p-2 text-gray-500 rounded'>Prev</button>
      </span>
      <span> |</span>
      <span class="text-gray-500" id='viewFingerprintPageCount'>1</span>
      <span> |</span>
      <span>
        <button id='viewFingerprintNextBtn' onclick='nextBtn(".fingerprint-table","fingerprintNoResult","viewFingerprintPrevBtn", "viewFingerprintNextBtn", "viewFingerprintPageCount")'
