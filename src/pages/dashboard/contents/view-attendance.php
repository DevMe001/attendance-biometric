...
<!-- end attendace -->
    ...
    <hr />
     ...
     <div class='flex justify-end gap-2 pr-5 items-center'>
      ...
      <span>
        <button id='viewattendancePrevBtn' onclick='prevBtn(".att-table","att_NoResult","viewattendancePrevBtn", "viewattendanceNextBtn", "viewattendancePageCount")'
      ...
      <span> |</span>
      <span>
        <button id='viewattendanceNextBtn' onclick='nextBtn(".att-table","att_NoResult","viewattendancePrevBtn", "viewattendanceNextBtn", "viewattendancePageCount")'
