...
<!-- <div class='flex justify-end gap-2 pr-5 items-center'>
 ...
 <div class='flex justify-end gap-2 pr-5 items-center'>
      ...
      <span>
        <button id='viewsectionNextBtn' onclick='prevBtn(".section-table","sectionNoResult","viewsectionPrevBtn", "viewsectionNextBtn", "viewsectionPageCount")'
          class='prev btn btn-blue-500 p-2 text-gray-500 rounded'>Prev</button>
      </span>
      <span> |</span>
      <span class="text-gray-500" id='viewsectionPageCount'> 1</span>
      <span> |</span>
      <span>
        <button id='viewsectionNextBtn' onclick='nextBtn(".section-table","sectionNoResult","viewsectionPrevBtn", "viewsectionNextBtn", "viewsectionPageCount")'
