...
`
  ...
  <div class='flex justify-end gap-2 pr-5 items-center'>
      ...
      <span>
        <button id='viewUsersPrevBtn' onclick='prevBtn(".users-table","usersNoResult","viewUsersPrevBtn", "viewUsersNextBtn", "viewUsersPageCount")'
          class='prev btn btn-blue-500 p-2 text-gray-500 rounded'>Prev</button>
      </span>
      <span> |</span>
      <span class="text-gray-500" id='viewUsersPageCount'>1</span>
      <span> |</span>
      <span>
        <button id='viewUsersNextBtn' onclick='nextBtn(".users-table","usersNoResult","viewUsersPrevBtn", "viewUsersNextBtn", "viewUsersPageCount")'
