  ...
  <div class='w-full mx-auto bg-white-500 shadow rounded mt-10 overflow-x-auto'>
    ...
    <table class="custom-table subject-table w-auto md:min-w-[37.5rem] lg:min-w-[100%] mx-auto mb-2 w-full">
      ...
      <tbody>
        ...
        <tr id='subjectNoResult' class='hidden'>
            <td colspan='4' class='text-gray-500 font-semibold'>No match found!</td>
        </tr>
      </tbody>
    ...
    <hr />
     ...
     <div class='flex justify-end gap-2 pr-5 items-center'>
      ...
      <span>
        <button id='viewsubjectPrevBtn' onclick='prevBtn(".subject-table","subjectNoResult","viewsubjectPrevBtn", "viewsubjectNextBtn", "viewsubjectPageCount")'
          class='prev btn btn-blue-500 p-2 text-gray-500 rounded'>Prev</button>
      </span>
      <span> |</span>
      <span class="text-gray-500" id='viewsubjectPageCount'> 1</span>
      <span> |</span>
      <span>
        <button id='viewsubjectNextBtn' onclick='nextBtn(".subject-table","subjectNoResult","viewsubjectPrevBtn", "viewsubjectNextBtn", "viewsubjectPageCount")'
