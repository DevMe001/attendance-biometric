...
<div class='w-[90%] mx-auto'>
  ...
  <div class='w-full mx-auto bg-white-500 shadow rounded mt-10'>
    ...
    <table class="custom-table archive-table w-auto md:min-w-[37.5rem] lg:min-w-[100%] mx-auto mb-2">
  ...
  <tr>
    ...
    <table class="archive-printable printable w-auto md:min-w-[37.5rem] lg:min-w-[40rem] mx-auto mb-2 hidden">
      <thead class='bg-[#19397D] text-white mx-auto'>
        <tr>
    ...
    <div class='flex justify-end gap-2 pr-5 items-center'>
      ...
      <span>
        <button id='viewarchivePrevBtn' onclick='prevBtn(".archive-table","archiveNoResult","viewarchivePrevBtn", "viewarchiveNextBtn", "viewarchivePageCount")'
          class='prev btn btn-blue-500 p-2 text-gray-500 rounded'>Prev</button>
      </span>
      <span> |</span>
      <span class="text-gray-500" id='viewarchivePageCount'>1</span>
      <span> |</span>
      <span>
        <button id='viewarchiveNextBtn' onclick='nextBtn(".archive-table","archiveNoResult","viewarchivePrevBtn", "viewarchiveNextBtn", "viewarchivePageCount")'
