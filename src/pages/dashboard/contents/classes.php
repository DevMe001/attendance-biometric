...
<div class='w-[90%] mx-auto'>
 ...
 <thead class='bg-[#19397D] text-white mx-auto'>
  ...
  foreach ($getClassRec as $keySub => $class) {
    ...
    $classRecDb = json_encode(array('id' => $class['class_id'],  'teacherId' => $class['teacher_id'], 'section_id' => $class['sectionId'], 'subjectId' => $class['subjectId'], 'yearId' => $class['yearId'], 'timeofDay' => $class['timeofDay'], 'schedule' => $class['scheduled_time']));
  ...
  <div class='flex justify-end gap-2 pr-5 items-center'>
      ...
      <span>
        <button id='viewclassesPrevBtn' onclick='prevBtn(".classes-table","classesNoResult","viewclassesPrevBtn", "viewclassesNextBtn", "viewclassesPageCount")'
          class='prev btn btn-blue-500 p-2 text-gray-500 rounded'>Prev</button>
      </span>
      <span> |</span>
      <span class="text-gray-500" id='viewclassesPageCount'> 1</span>
      <span> |</span>
      <span>
        <button id='viewclassesNextBtn' onclick='nextBtn(".classes-table","classesNoResult","viewclassesPrevBtn", "viewclassesNextBtn", "viewclassesPageCount")'
